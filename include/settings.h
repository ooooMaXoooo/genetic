#pragma once
/*
    Pour avoir les couleurs des commentaires, il faut installer l'extension
Better Comments (pour VS Code) :
    https://marketplace.visualstudio.com/items?itemName=aaron-bond.better-comments


?   Un commentaire écrit de cette couleur, dans ce fichier uniquement,
correspond à une valeur modifiable par l'utilisateur. (--> ? devant le
commentaire) !   Un commentaire écrit de cette couleur, dans ce fichier
uniquement, correspond à une valeur non modifiable par l'utilisateur. (--> !
devant le commentaire)
*/
...
constexpr size_t HalfPopulationSize = 1000;                //? la moité de la taille de la population
...
constexpr real initial_propa = real(0.9);

//======= Paramètres de sauvegarde dans des fichiers =======//
constexpr std::string_view directory = "./data";  //? le dossier dans lequel sauvegarder les fichiers de sauvegarde
constexpr std::string_view extension_generations = ".gen";  //? l'extension des fichiers générés
constexpr std::string_view extension_individuals =
    ".ind";  //? l'extension des fichiers contenant les meilleurs et pires individus
